    ...
    <div className="space-y-6">
      <section className="grid gap-4 xl:grid-cols-[1.15fr_0.85fr]">
        <div className="rounded-[2rem] border border-border/50 bg-card p-6">
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            ...
            <Link href="/insights/explorer" className="rounded-xl border border-border/60 px-4 py-2 text-sm text-foreground">
              Open explorer view
            </Link>
          </div>
        </div>
      ...
      <section className="rounded-[2rem] border border-border/50 bg-card p-6">
        <div className="flex items-center justify-between gap-4">
          ...
          <Link href="/insights/benefits" className="hidden items-center gap-2 text-sm text-muted-foreground hover:text-foreground sm:flex">
